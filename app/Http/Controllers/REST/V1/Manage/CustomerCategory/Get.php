...
class Get extends BaseREST
{
    ...
    protected $payloadRules = [
        'id' => 'nullable|integer|exists:customer_categories,id',
        'business_id' => 'nullable|integer|exists:business,id', // Filter penting
    ...
    public function get()
    {
        ...
        if (isset($this->payload['id'])) {
            return $this->error((new Errors)->setMessage(404, 'Customer category not found.'));
        }
